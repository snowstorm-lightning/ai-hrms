  ...
  return (
    <main className="login-page">
      <section className="login-hero">
        <Tag color="blue">Assignment Demo</Tag>
        ...
        <Alert
          ...
          type="info"
          title="Demo 使用 deterministic mock AI"
          description="不调用外部 LLM，不发送个人敏感数据；高风险 HR 建议只生成预览并要求人工确认。"
        />
      </section>
      <section className="login-panel">
        <Typography.Title level={2}>进入 AI-HRMS Demo</Typography.Title>

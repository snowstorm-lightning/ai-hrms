...
const zhCN: Dictionary = {
  ...
  dashboard: {
    ...
    description: "连接组织数据、知识库、学习成长、智能任务运行和审计治理，让 HR 与智能服务协作完成更可信的人力资源工作。",
    commandPlaceholder: "问组织、查知识、生成计划、预览动作、调度智能任务",
    demoCommandButton: "生成预览",
    realCommandButton: "进入 AI 指挥中心",
    trustTitle: "信任层快照",
    highRiskTitle: "高风险人事建议不会自动执行",
    highRiskDescription: "系统只允许生成预览、进入人工确认、查看证据和写入审计。",
    ...
    programPreview: "该问题由程序化查询或受控知识检索处理，不创建智能任务运行；需要自然语言生成或跨模块行动时再升级到智能任务。",

...
const zhCN: Dictionary = {
  ...
  dashboard: {
    ...
    realModePreview: "真实模式下将进入 AI 指挥中心，由权限、可见范围、知识检索和审计边界处理建议生成。",
...
const enUS: Dictionary = {
  ...
  dashboard: {
    ...
    realModePreview: "Real mode will open AI Command Center, where permissions, visibility, knowledge retrieval, and audit boundaries handle the suggestion.",

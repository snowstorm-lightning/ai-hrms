...
VALUES
  ('00000000-0000-0000-0000-000000000101', NULL, 'GROUP', '企鹅科技集团', '企鹅互联网科技有限公司', '91440300PENGUIN001', '许海川', '0755-86000000', 'people@penguin.example', '深圳', '深圳市南山区海湾科技园 1 号'),
  ('00000000-0000-0000-0000-000000000102', '00000000-0000-0000-0000-000000000101', 'SUB-A', '企鹅企业服务', '企鹅企业服务有限公司', '91440300PENGUIN002', '罗启明', '0755-86000002', 'enterprise-hr@penguin.example', '深圳', '深圳市南山区企业服务路 8 号'),
  ('00000000-0000-0000-0000-000000000103', '00000000-0000-0000-0000-000000000101', 'SUB-B', '企鹅协同产品', '企鹅协同产品有限公司', '91440300PENGUIN003', '顾明远', '028-86000003', 'penguin-collab-hr@penguin.example', '成都', '成都市高新区协同产品大道 12 号'),
  ('00000000-0000-0000-0000-000000000104', '00000000-0000-0000-0000-000000000101', 'PENGUIN-RISK', '企鹅风控科技', '企鹅风控科技有限公司', '91440300PENGUIN004', '沈知衡', '020-86000004', 'risk-hr@penguin.example', '广州', '广州市天河区风险治理路 6 号'),
  ('00000000-0000-0000-0000-000000000105', '00000000-0000-0000-0000-000000000101', 'PENGUIN-GROWTH', '企鹅增长科技', '企鹅增长科技有限公司', '91440300PENGUIN005', '周雨桐', '0571-86000005', 'growth-ops@penguin.example', '杭州', '杭州市余杭区增长街 9 号')
...
VALUES
  ('00000000-0000-0000-0000-000000000401', '00000000-0000-0000-0000-000000000301', 'PG001', '许安宁', '13000001001', 'active', '未知', '硕士', '深圳', '中国人民大学', '组织发展', '企鹅科技集团', '集团 HR', '模拟公司样本：集团 HR 和 Demo 主讲角色'),
  ('00000000-0000-0000-0000-000000000402', '00000000-0000-0000-0000-000000000302', 'PG002', '陈向南', '13000001002', 'active', '未知', '本科', '深圳', '华南理工大学', '人力资源', '企鹅企业服务', 'HRBP', '模拟公司样本：企业服务 HRBP'),
  ('00000000-0000-0000-0000-000000000403', '00000000-0000-0000-0000-000000000303', 'PG003', '林晨', '13000001003', 'active', '未知', '本科', '深圳', '同济大学', '软件工程', '企鹅科技集团', 'AI 平台研发工程师', '模拟公司样本：新人研发，参与 Co-Growth mission'),
  ('00000000-0000-0000-0000-000000000404', '00000000-0000-0000-0000-000000000304', 'PG004', '周雨桐', '13000001004', 'active', '未知', '硕士', '杭州', '浙江大学', '计算机科学', '企鹅增长科技', '算法导师', '模拟公司样本：导师，复核新人 AI Work Journal'),
  ('00000000-0000-0000-0000-000000000405', NULL, 'PG005', '顾明远', '13000001005', 'active', '未知', '硕士', '成都', '电子科技大学', '协同产品工程', '企鹅协同产品', '业务管理者', '模拟公司样本：关注组织能力和 Agent 风险'),
  ('00000000-0000-0000-0000-000000000406', NULL, 'PG006', '沈知衡', '13000001006', 'active', '未知', '博士', '广州', '中山大学', '信息安全', '企鹅风控科技', 'AI 安全与审计负责人', '模拟公司样本：负责知识治理和风险边界')
ON CONFLICT (id) DO UPDATE SET
...
UPDATE messages SET
  ...
  content = '<p>本环境使用虚构的企鹅互联网科技有限公司作为模拟租户，用于展示 AI-HRMS 的组织、知识、Agent 与审计闭环。</p>',
  star = 12,
  view_count = 168,
  updated_at = now()
...
VALUES
  ('00000000-0000-0000-0000-000000000902', 'upload', '企鹅科技 HR 制度库', 'seed://penguin-hr-policy', 'active', '00000000-0000-0000-0000-000000000301'),
  ('00000000-0000-0000-0000-000000000903', 'upload', '企鹅科技 AI 治理资料包', 'seed://penguin-ai-governance', 'active', '00000000-0000-0000-0000-000000000301')
ON CONFLICT (id) DO UPDATE SET
...
VALUES
  ('00000000-0000-0000-0000-000000000912', '00000000-0000-0000-0000-000000000902', '企鹅科技新员工入职指南', 'v1', 'published', 'official', 'normal',
   '企鹅科技新员工入职 7 天内完成账号、信息安全、协作工具和事业群业务导览。30 天内由导师完成一次成长复盘，确认工作上下文、学习计划和协作风险。', encode(digest('企鹅科技新员工入职指南', 'sha256'), 'hex'), now(), '00000000-0000-0000-0000-000000000301'),
  ('00000000-0000-0000-0000-000000000913', '00000000-0000-0000-0000-000000000903', '企鹅科技 AI 使用安全规范', 'v1', 'published', 'official', 'normal',
   '员工不得把客户数据、未授权代码、密钥、员工敏感信息或高影响人事决策材料直接放入外部 AI prompt。AI 生成建议必须保留 evidence、riskLevel、confidence 和 humanReviewRequired。', encode(digest('企鹅科技 AI 使用安全规范', 'sha256'), 'hex'), now(), '00000000-0000-0000-0000-000000000301'),
...
VALUES
  ('00000000-0000-0000-0000-000000000922', '00000000-0000-0000-0000-000000000912', 0, '企鹅科技入职 7/30 天要求', '企鹅科技新员工入职 7 天内完成账号、信息安全、协作工具和事业群业务导览。30 天内由导师完成一次成长复盘。', encode(digest('企鹅科技入职 7/30 天要求', 'sha256'), 'hex'), 'normal'),
...
VALUES
  ('00000000-0000-0000-0000-000000000934', '企鹅科技新人 30 天融入计划', '面向综合互联网业务新人，覆盖信息安全、事业群协作、AI 工具边界和导师复盘。', 'published', 'global', '00000000-0000-0000-0000-000000000301'),
...
VALUES
  ('00000000-0000-0000-0000-000000000936', '00000000-0000-0000-0000-000000000934', '企鹅科技组织与业务导览', '了解协同产品、内容运营、企业服务、风险策略、增长运营和 AI 平台的协作方式。', 1, '00000000-0000-0000-0000-000000000912'),
